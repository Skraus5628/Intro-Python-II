...
room = {
    'outside':  Room("Outside Cave Entrance",
                     "North of you, the cave mount beckons", Item('Club')),
...
to north. The smell of gold permeates the air.""", Item('Old Toast')),

    'treasure': Room("Treasure Chamber", """You've found the long-lost treasure
chamber! Sadly, it has already been completely emptied by
earlier adventurers. The only exit is to the south.""", Item('Map')),
}
...
player_inventory= [x.name for x in player.inventory] if len(player.inventory) else "Empty Pack"
